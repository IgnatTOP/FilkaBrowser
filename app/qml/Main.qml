...
// Filka Browser — root window shell (M0).
// Frameless, translucent window with an animated "aurora glass" backdrop that
// establishes the premium depth language. Real browser content lands here in
// later milestones (M2+).
ApplicationWindow {
    id: appWindow
    width: 1280
    ...
    Rectangle {
        ...
        Item {
            ...
            Repeater {
                model: [
                    { c: Theme.electricBlue, x0: 0.12, y0: 0.10, d: 9000,  s: 0.62 },
                    { c: Theme.auroraPurple, x0: 0.70, y0: 0.05, d: 11000, s: 0.74 },
                    { c: Theme.cyan,         x0: 0.50, y0: 0.65, d: 13000, s: 0.56 }
                ]
                delegate: Rectangle {
                    id: blob
